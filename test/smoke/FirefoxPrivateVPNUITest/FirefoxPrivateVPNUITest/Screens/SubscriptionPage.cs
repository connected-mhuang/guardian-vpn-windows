...
namespace FirefoxPrivateVPNUITest.Screens
{
    ...
    internal class SubscriptionPage
    {
        ...
        public SubscriptionPage(WindowsDriver<WindowsElement> browserSession)
        {
            ...
            this.cardNumberInput = browserSession.FindElementByName("Credit or debit card number");
            this.expDateInput = browserSession.FindElementByName("Credit or debit card expiration date");
            this.cvcInput = browserSession.FindElementByName("Credit or debit card CVC/CVV");
            this.zipCodeInput = browserSession.FindElementByName("ZIP code 12345");
            this.authorizeCheckbox = browserSession.FindElementByXPath("//CheckBox");
            this.submit = browserSession.FindElementByName("Submit");
        }
