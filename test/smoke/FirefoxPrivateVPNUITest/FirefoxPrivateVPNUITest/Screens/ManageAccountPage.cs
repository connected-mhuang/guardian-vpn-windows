...
namespace FirefoxPrivateVPNUITest.Screens
{
    ...
    internal class ManageAccountPage
    {
        ...
        private WindowsElement firefoxAccountDoc;
        ...
        public ManageAccountPage(WindowsDriver<WindowsElement> browserSession)
        {
            ...
            this.firefoxAccountDoc = browserSession.FindElementByName("Firefox Accounts");
        }
        ...
        public void ClickDeleteButton()
        {
            ...
            var deleteButton = this.browserSession.FindElementByXPath("//Button[@Name=\"Delete…\"]");
            deleteButton.Click();
        }
